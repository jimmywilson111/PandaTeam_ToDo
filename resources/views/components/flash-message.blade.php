@if ($message = Session::get('success'))
    <div id="alert-3" class="flex p-4 md:mx-2 mt-4 bg-green-100 rounded-lg shadow-sm border-b border-gray-200" role="alert">
...
@if ($message = Session::get('error'))
    <div id="alert-2" class="flex p-4 md:mx-2 mt-4 bg-red-100 rounded-lg" role="alert">
...
@if ($message = Session::get('warning'))
    <div id="alert-4" class="flex p-4 md:mx-2 mt-4 bg-yellow-100 rounded-lg" role="alert">
...
@if ($message = Session::get('info'))
    <div id="alert-1" class="flex p-4 md:mx-2 mt-4 bg-blue-100 rounded-lg" role="alert">
